...
Bash
git clone [https://github.com/your-username/bloodlife.git](https://github.com/your-username/bloodlife.git)
cd bloodlife
2. Database Configuration
Open pgAdmin or your psql terminal.

Create the target database: CREATE DATABASE bloodlife_db;

Execute the provided SQL schema script (e.g., located in src/main/resources/schema.sql) to generate the required tables, enums, and views.

Update your database credentials within the connection class (e.g., DatabaseConnection.java):
